...
opentable($locale['shp_mv_1']);

$result = dbquery("SELECT * FROM ".DB_AL_SHOP_GOODS." ORDER BY shp_good_views DESC LIMIT 0,3");
if (dbrows($result)) {
    ...
    while ($data = dbarray($result)) {
        ...
        echo "<a href='".BASEDIR."shop.php?action=good&id=".$data['shp_good_id']."'><img src='".$img."' width='".$shop_settings['thumb_width']."' /><br />".$data['shp_good_title']."</a><br />".show_cost($data['shp_good_cost'],$data['shp_good_currency'],$shop_settings['currency_default'])."<br />";
